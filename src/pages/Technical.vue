		...
		<form ref="form1" enctype="multipart/form-data">
			...
			<div class="row">
				<div class="col-md-4 col-xs-12">
					<span>承&nbsp;&nbsp;包&nbsp;&nbsp;商</span>
					<input type='text' class="input_s" name="contractor_name" v-model="contractor">
				</div>
				<div class="col-md-4 col-xs-12">
					<span>项目名称</span>
					<input type='text' class="input_s" name="contract_name" v-model="contract">
				</div>
				<div class="col-md-4 col-xs-12">
					<span>工程名称</span>
					<input type='text' class="input_s" name="engineer_name" v-model="engineer">
				</div>
				<div class="col-md-4 col-xs-12">
					<span>评审时间</span>
					<input type='text' class="input_s" name="review_time" v-model="review">
				</div>
				<div class="col-md-4 col-xs-12">
					<span>进场时间</span>
					<input type='text' class="input_s" name="start_time" v-model="start">
				</div>
				<div class="col-md-4 col-xs-12">
					<span>完工时间</span>
					<input type='text' class="input_s" name="stop_time" v-model="stop">
				</div>
			</div>
			<div class="head_btn">
				<span>评定细则</span>
			...
			<div class="row">
				...
				<div class="col-md-6 col-xs-12">
					<ul>
						<li>总&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;得&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;分 <input type="text" class="input_s" name="total_score"></li>
